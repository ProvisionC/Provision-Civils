...
export function QRCard({ name, clockNumber }: QRCardProps) {
    ...
    <View style={[styles.card, { backgroundColor: colors.card, borderColor: colors.border }]}>
      ...
      <View style={styles.content}>
        <View style={styles.qrContainer}>
          <QRCode value={clockNumber} size={150} color={colors.foreground} backgroundColor={colors.card} />
        </View>
...
const styles = StyleSheet.create({
  card: {
    width: 250, height: 350, borderRadius: 12, padding: 20,
